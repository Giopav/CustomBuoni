...
public class BuonoDescrizione extends Buono {
    public BuonoDescrizione() {
        super(BuonoType.DESCRIZIONE,
                ChatColor.WHITE + "Buono " + ChatColor.DARK_PURPLE + "descrizione",
                ChatColor.GRAY + "» ",
                ChatColor.DARK_GRAY + "Cambia la descrizione di un item!");
    }
